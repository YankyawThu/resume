    ...
    return (
      <div className="flex flex-row justify-center py-3 items-center">
        <div className="relative mr-5">
          ...
          <Image src="/welcomeText.png" width={100} height={100} alt="welcome" className="absolute max-w-none w-[150px] h-[90px] top-6 right-10" />
        </div>
        {theme == 'dark' ? 
    ...
    return (
      <div className="projects my-14 lg:my-[100px]">
        ...
        <div className="grid grid-rows-3 lg:grid-rows-1 lg:grid-cols-3 gap-y-8 lg:gap-x-8 mx-5 justify-items-center">
          <div className="proj-card shadow-lg shadow-cyan-500/50">
            <span className="icon">
