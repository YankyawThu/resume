    ...
    return (
      <div className="projects my-14 lg:my-[100px]">
        ...
        <div className="grid grid-rows-3 lg:grid-rows-1 lg:grid-cols-3 gap-y-8 lg:gap-x-8 mx-5 justify-items-center">
          ...
          <div className="proj-card shadow-lg shadow-cyan-500/50" data-aos="fade-down" data-aos-duration="500">
            <span className="icon">
      ...
      <div className="grid grid-rows-2 lg:grid-rows-1 lg:grid-cols-2 gap-y-8 lg:gap-y-0 my-10 lg:my-[100px]">
        ...
        <div className="flex flex-row border-l-[1px] border-black dark:border-white py-[20px]">
          <div className="flex-none w-10 flex flex-col self-center lg:mr-10 border-[1px] border-l-0 border-black dark:border-white rounded-tr rounded-br">
            <div className="line-link relative">
              <FaLine className="text-lg cursor-pointer text-green-400 w-full h-10 p-2 border-b-[1px] border-black dark:border-white" />
              <div className="line-tooltip bg-white shadow-lg text-gray-500 dark:text-gray-400">LineID: <span className="text-cyan-500">swayandee</span></div>
            </div>
            <div className="whatsapp-link relative">
              <FaWhatsapp className="text-lg cursor-pointer text-green-400 w-full h-10 p-2 border-b-[1px] border-black dark:border-white" />
              <div className="whatsapp-tooltip bg-white shadow-lg text-gray-500 dark:text-gray-400">WhatsApp: <span className="text-cyan-500">+66 0611077375</span></div>
            </div>
